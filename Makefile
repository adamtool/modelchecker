...
DEPENDENCIES_REPOS="https://github.com/adamtool/libs.git,https://github.com/adamtool/examples.git,https://github.com/adamtool/framework.git,https://github.com/adamtool/logics.git"
