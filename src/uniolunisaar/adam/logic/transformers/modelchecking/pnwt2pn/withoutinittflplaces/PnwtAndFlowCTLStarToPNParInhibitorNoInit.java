 ...
 */
public class PnwtAndFlowCTLStarToPNParInhibitorNoInit extends PnwtAndFlowCTLStarToPNNoInit {
     ...
     * @return
     */
    public static PetriNetWithTransits createNet4ModelCheckingParallel(PetriNetWithTransits net, IRunFormula formula, int nb_flowFormulas) {
