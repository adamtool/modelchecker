...
/**
 *
 * This should be the same class as PnwtAndNbFlowFormulas2PNParInhibitorNoInit,
 * but here we use the power set to calculate the connections for each
 * transition and each of its transits the new transitions of the model checking
 * net and the connections. This means this only works correctly when each
 * transition only has one transit.
 *
 *
 * The class PnwtAndNbFlowFormulas2PNParInhibitorNoInit is a copy of
 * PnwtAndFlowLTLtoPNParallelInhibitor but simplified such that it is not
 * possible to have places starting flow chains.
 *
 * @author Manuel Gieseking
 */
public class PnwtAndNbFlowFormulas2PNParInhibitorNoInitOnlyOneTransitPerTransition extends PnwtAndNbFlowFormulas2PNNoInit {
